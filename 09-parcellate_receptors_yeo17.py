# -*- coding: utf-8 -*-
"""
Here we parcellate volumetric PET images. We need to do this because
we are using schaefer with the 17 Yeo Networks, in contrast to 
Hansen, et al.  Nat Neurosci 25, 1569–1581 (2022).
"""
...
path = "/home/javi/Documentos/meg-excitability-clustering/hansen_receptors-main/data/PET_nifti_images/"
outpath = "/home/javi/Documentos/meg-excitability-clustering/data/receptors/"+scale+"/"
...
receptors_nii = [path+'5HT1a_way_hc36_savli.nii',
                 ...
                 #path+'VAChT_feobv_hc3_spreng.nii', JAVI: this is not available
...
for receptor in tqdm(receptors_nii):
    parcellated[receptor] = parcellater.fit_transform(receptor, 
                                                      'MNI152', ignore_background_data = True)
